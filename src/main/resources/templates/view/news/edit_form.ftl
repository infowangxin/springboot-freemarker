...
<div class="form-group">
    <label class="col-sm-4 control-label" for="title">标题
...
<div class="form-group">
    <label class="col-sm-4 control-label" for="description">内容
        <span class="text-danger">*</span>
    </label>
    <div class="col-sm-8">
...
<div class="form-group">
    <label class="col-sm-4 control-label" for="address">地址
        <span class="text-danger">*</span>
    </label>
    <div class="col-sm-8">
...
<div class="form-group">
    <label class="col-sm-4 control-label" for="newsTime">新闻发生时间
        <span class="text-danger">*</span>
    </label>
    <div class="col-sm-8">
